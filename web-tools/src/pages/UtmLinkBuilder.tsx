...
import {
  Container, Box, Typography, Card, CardContent, Button, Alert, Grid, Paper, TextField, IconButton, Tooltip, Chip,
} from '@mui/material';
import { ContentCopy as CopyIcon, Clear as ClearIcon, Link as LinkIcon, OpenInNew as OpenIcon } from '@mui/icons-material';
